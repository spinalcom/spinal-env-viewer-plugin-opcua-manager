...
import { CREATE_SUBNETWORK_DIALOG_IN_OPCUA } from "../js/constants"
...
class CreateSubNetworkBtn extends SpinalContextApp {
    ...
    async isShown(option) {
        ...
        const result = typeSelected === OPCUA_ORGAN_TYPE ? true : -1;
    ...
    action(option) {
        spinalPanelManagerService.openPanel(CREATE_SUBNETWORK_DIALOG_IN_OPCUA, option)
    }
